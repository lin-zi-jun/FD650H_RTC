...
i2c_master_setAck(uint8 level)
{
    ...
    i2c_master_wait(100);
    i2c_master_setDC(level, 0);
    i2c_master_wait(100);	// sda level, scl 0
    i2c_master_setDC(level, 1);
    i2c_master_wait(100);	// sda level, scl 1
    i2c_master_setDC(level, 0);
    i2c_master_wait(100);	// sda level, scl 0
    i2c_master_setDC(1, 0);
    i2c_master_wait(100);
...
i2c_master_readByte(void)
{
    ...
    i2c_master_wait(100);
    i2c_master_setDC(m_nLastSDA, 0);
    i2c_master_wait(100);	// sda 1, scl 0
    ...
    for (i = 0; i < 8; i++) {
        ...
        i2c_master_wait(100);	// sda 1, scl 0
        i2c_master_setDC(1, 1);
        i2c_master_wait(100);	// sda 1, scl 1
